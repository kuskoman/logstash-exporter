...
| logstash_stats_pipeline_pipeline_plugin_events_duration | counter | Time spent processing events in this plugin. |
| logstash_stats_pipeline_pipeline_plugin_events_in | counter | Number of events received this pipeline. |
| logstash_stats_pipeline_pipeline_plugin_events_out | counter | Number of events output by this pipeline. |
| logstash_stats_pipeline_pipeline_plugin_events_queue_push_duration | counter | Time spent pushing events into the input queue. |
